import { type Container, createContainer } from '@core/container/container.js'
import compress from '@fastify/compress'
import cors from '@fastify/cors'
import helmet from '@fastify/helmet'
import rateLimit from '@fastify/rate-limit'
import { registerAuthRoutes } from '@features/auth/infrastructure/http/routes/routes.js'
import { registerTeamRoutes } from '@features/teams/infrastructure/http/routes/routes.js'
import { registerUserRoutes } from '@features/users/infrastructure/http/routes/routes.js'
import { type Env, validateEnv, validateProductionEnv } from '@shared/config/env.js'
...
import { createMetricsOnRequest, createMetricsOnResponse } from '@shared/http/middleware/metrics.js'
import { FastifyLogger } from '@shared/logging/FastifyLogger.js'
import { createLoggerConfig } from '@shared/logging/logger-config.js'
